...
public class CrmWebServerBase implements CrmWebServer {
    ...
    public CrmWebServerBase(int port, DBServiceClient dbServiceClient, Gson gson, TemplateProcessor templateProcessor) {
